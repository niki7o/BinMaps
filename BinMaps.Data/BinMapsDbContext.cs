...
new TrashContainer { Id = 125, LocationX = 23.281, LocationY = 42.708, AreaId = "Зона 3 - Люлин", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 37, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 126, LocationX = 23.288, LocationY = 42.671, AreaId = "Зона 4 - Овча Купел", TrashType = TrashType.Plastic, HasSensor = true, Temperature = 0, BatteryPercentage = 89, FillPercentage = 5, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 127, LocationX = 23.341, LocationY = 42.646, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 72, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 128, LocationX = 23.314, LocationY = 42.692, AreaId = "Зона 2 - Център", TrashType = TrashType.Paper, HasSensor = true, Temperature = 5, BatteryPercentage = 43, FillPercentage = 26, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 129, LocationX = 23.311, LocationY = 42.661, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Glass, HasSensor = true, Temperature = 45, BatteryPercentage = 61, FillPercentage = 83, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 130, LocationX = 23.362, LocationY = 42.688, AreaId = "Зона 6 - Изток", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 59, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 131, LocationX = 23.331, LocationY = 42.723, AreaId = "Зона 1 - Надежда север", TrashType = TrashType.Plastic, HasSensor = true, Temperature = 29, BatteryPercentage = 25, FillPercentage = 11, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 132, LocationX = 23.281, LocationY = 42.654, AreaId = "Зона 4 - Овча Купел", TrashType = TrashType.Paper, HasSensor = true, Temperature = 0, BatteryPercentage = 78, FillPercentage = 94, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 133, LocationX = 23.262, LocationY = 42.711, AreaId = "Зона 3 - Люлин", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 46, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 134, LocationX = 23.338, LocationY = 42.684, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Glass, HasSensor = true, Temperature = 39, BatteryPercentage = 90, FillPercentage = 38, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 135, LocationX = 23.355, LocationY = 42.665, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 17, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 136, LocationX = 23.351, LocationY = 42.735, AreaId = "Зона 1 - Надежда север", TrashType = TrashType.Plastic, HasSensor = true, Temperature = 25, BatteryPercentage = 14, FillPercentage = 70, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 137, LocationX = 23.305, LocationY = 42.698, AreaId = "Зона 2 - Център", TrashType = TrashType.Paper, HasSensor = true, Temperature = 63, BatteryPercentage = 55, FillPercentage = 85, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 138, LocationX = 23.279, LocationY = 42.674, AreaId = "Зона 4 - Овча Купел", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 62, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 139, LocationX = 23.348, LocationY = 42.641, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Glass, HasSensor = true, Temperature = 50, BatteryPercentage = 83, FillPercentage = 41, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 140, LocationX = 23.305, LocationY = 42.661, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 9, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 141, LocationX = 23.3745, LocationY = 42.6712, AreaId = "Зона 6 - Изток", TrashType = TrashType.Plastic, HasSensor = true, Temperature = 14, BatteryPercentage = 44, FillPercentage = 56, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 142, LocationX = 23.2882, LocationY = 42.6435, AreaId = "Зона 4 - Овча Купел", TrashType = TrashType.Paper, HasSensor = true, Temperature = 51, BatteryPercentage = 71, FillPercentage = 20, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 143, LocationX = 23.3321, LocationY = 42.7056, AreaId = "Зона 1 - Надежда север", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 88, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 144, LocationX = 23.2654, LocationY = 42.7214, AreaId = "Зона 3 - Люлин", TrashType = TrashType.Glass, HasSensor = true, Temperature = 70, BatteryPercentage = 96, FillPercentage = 35, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 145, LocationX = 23.3156, LocationY = 42.6789, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 12, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 146, LocationX = 23.3289, LocationY = 42.6952, AreaId = "Зона 2 - Център", TrashType = TrashType.Plastic, HasSensor = true, Temperature = 45, BatteryPercentage = 15, FillPercentage = 99, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 147, LocationX = 23.3642, LocationY = 42.6587, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Paper, HasSensor = true, Temperature = 20, BatteryPercentage = 82, FillPercentage = 47, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 148, LocationX = 23.2954, LocationY = 42.6721, AreaId = "Зона 4 - Овча Купел", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 61, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 149, LocationX = 23.3389, LocationY = 42.6472, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Glass, HasSensor = true, Temperature = 27, BatteryPercentage = 39, FillPercentage = 8, Capacity = 1100, Status = TrashContainerStatus.Active },
    new TrashContainer { Id = 150, LocationX = 23.3105, LocationY = 42.6631, AreaId = "Зона 5 - Юг и Витоша", TrashType = TrashType.Mixed, HasSensor = false, FillPercentage = 75, Capacity = 1100, Status = TrashContainerStatus.Active },
